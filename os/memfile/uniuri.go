...
// The contents of this file are from: https://github.com/dchest/uniuri
//
// Written in 2011-2014 by Dmitry Chestnykh
//
// "Package uniuri generates random strings good for use in URIs to
// identify unique objects."
//
// The author(s) have dedicated all copyright and related and neighboring
// rights to this software to the public domain worldwide.
//
// Distributed without any warranty. http://creativecommons.org/publicdomain/zero/1.0/
