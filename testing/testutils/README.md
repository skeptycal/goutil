...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/skeptycal/testutils/Go) ![Codecov](https://img.shields.io/codecov/c/github/skeptycal/testutils)
...
Developed with go version go1.17.6 darwin/arm64. Go is _extremely_ backwards compatible and semver stable. Nearly any v1.x should work fine.
...
```sh
gh repo create -y --public --template "https://github.com/skeptycal/testutils"
```
...
go get github.com/xxxxxx/testutils

cd ${GOPATH}/src/github.com/xxxxxx/testutils
...
> This is a copy of the example script available in the `cmd/example/testutils` folder:

```go
package main

import "github.com/skeptycal/testutils"
...
[issues]: (https://github.com/skeptycal/testutils/issues)
[pr]: (https://github.com/skeptycal/testutils/pulls)
