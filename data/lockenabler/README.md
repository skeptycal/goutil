...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/skeptycal/lockenabler/Go) ![Codecov](https://img.shields.io/codecov/c/github/skeptycal/lockenabler)
...
Developed with _go version go1.18 darwin/arm64_. Go is _extremely_ backwards compatible and semver stable. Nearly any v1.x should work fine.
...
```sh
gh repo create -y --public --template "https://github.com/skeptycal/lockenabler"
```

Clone this repo to test and contribute:

```bash
# add repo to $GOPATH ($(whoami) is your computer
# login username and the name of your home directory)
go get github.com/$(whoami)/lockenabler

cd ${GOPATH}/src/github.com/$(whoami)/lockenabler
...
> This is a copy of the example script available in the `cmd/example/lockenabler` folder:

```go
package main

import "github.com/skeptycal/lockenabler"
...
[issues]: (https://github.com/skeptycal/lockenabler/issues)
[pr]: (https://github.com/skeptycal/lockenabler/pulls)
