...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/skeptycal/goalgo/Go) ![Codecov](https://img.shields.io/codecov/c/github/skeptycal/goalgo)
...
```sh
gh repo create -y --public --template "https://github.com/skeptycal/goalgo"
```
...
go get github.com/xxxxxx/goalgo

cd ${GOPATH}/src/github.com/xxxxxx/goalgo
...
> This is a copy of the example script available in the `cmd/example/goalgo` folder:
...
[issues]: (https://github.com/skeptycal/goalgo/issues)
[pr]: (https://github.com/skeptycal/goalgo/pulls)
