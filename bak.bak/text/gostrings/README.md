...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/skeptycal/gostrings/Go) ![Codecov](https://img.shields.io/codecov/c/github/skeptycal/gostrings)
...
```sh
gh repo create -y --public --template "https://github.com/skeptycal/gostrings"
```
...
go get github.com/xxxxxx/gostrings

cd ${GOPATH}/src/github.com/xxxxxx/gostrings
...
> This is a copy of the example script available in the `cmd/example/gostrings` folder:

```go
package main

import "github.com/skeptycal/gostrings"
...
[issues]: (https://github.com/skeptycal/gostrings/issues)
[pr]: (https://github.com/skeptycal/gostrings/pulls)
