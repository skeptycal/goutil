...
import (
	...
	"github.com/skeptycal/goutil/types/anyvalue"
)
...
//
//
func IsOrdered(v Any) bool { return NewAnyValue(v).IsOrdered() }
...
func IsDeepComparable(v Any) bool { return NewAnyValue(v).IsDeepComparable() }
...
// values and structs.
func IsIterable(v Any) bool { return NewAnyValue(v).IsIterable() }

// HasAlternate returns true if the underlying value has
// alternate methods in addition to the Go standard library
// operations.
func HasAlternate(v Any) bool { return NewAnyValue(v).HasAlternate() }
